...
<script>
import { getCheckErrList, setCheckStatus, getCheckErrTotal } from "@/api/certification";
...
export default {
  ...
  data() {
    return {
      ...
      tableHeader: [
        ...
        { label: "起始时间", prop: "stime", open: false, time: true },
        { label: "结束时间", prop: "etime", open: false, time: true },
  ...
  methods: {
    ...
    async init() {
      ...
      let objtotal = await getCheckErrTotal({ fileId: this.fileId })
